...
public class PasswordTxt extends JPasswordField {
    ...
    public PasswordTxt() {
        ...
        eye = new ImageIcon(getClass().getResource("/com/hotelmanage/icon/eye_hide.png")).getImage();
        eye_hide = new ImageIcon(getClass().getResource("/com/hotelmanage/icon/eye.png")).getImage();
    ...
    public void paint(Graphics grphcs) {
        ...
        if (mouseOver) {
            g2.setColor(new Color(0x7ECA9C));
        } else {
            g2.setColor(new Color(0x1C1427));
        }
